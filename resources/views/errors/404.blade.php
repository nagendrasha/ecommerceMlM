...
<!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v36/ekka-html/404-error-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Dec 2023 17:43:36 GMT -->
<head>
    <meta charset="UTF-8">
           ...
           <div class="row">
               <div class="col-md-6">
                   <div class="under-maintenance">
                       ...
                       <p>The Page Your are looking for is not found or may be removed. Please contact us <b><a href="{{route('frontend_contactus')}}">click here</a></b> else Please click to back to Home.</p>
                       <a href="{{url('/')}}" class="btn btn-lg btn-primary" tabindex="0">Back to Home</a>
                   </div>
               </div>
               <div class="col-md-6 disp-768">
                   <div class="under-maintenance">
                       <img class="maintenance-img" src="{{asset('Front/assets/images/common/404.png')}}" alt="maintenance">
                   </div>
               </div>
           </div>
       </div>
