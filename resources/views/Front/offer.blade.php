    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                <div class="ec-offer-coupon">
                    <div class="ec-cpn-brand">
                        <img class="ec-brand-img" src="{{asset('Front/assets/images/offer-image/2.jpg')}}" alt="" />
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 margin-b-30">
                <div class="ec-offer-coupon">
                    <div class="ec-cpn-brand">
                        <img class="ec-brand-img" src="{{asset('Front/assets/images/offer-image/3.jpg')}}" alt="" />
                    </div>
                    <div class="ec-cpn-title">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 m-auto">
                <div class="ec-offer-coupon">
                    <div class="ec-cpn-brand">
                        <img class="ec-brand-img" src="{{asset('Front/assets/images/offer-image/4.jpg')}}" alt="" />
                    </div>
                    <div class="ec-cpn-title">
