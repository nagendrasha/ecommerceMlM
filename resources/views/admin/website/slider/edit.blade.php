            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin_slider_edit', encrypt($slider->id)) }}" method="POST"
                                            ...
                                            <div class="row form-c g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="name" name="name" value="{{ $slider->name }}">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="url"
                                                        class="form-control slug-title @error('link') is-invalid @enderror"
                                                ...
                                                <div class="col-md-12">
                                                    <label class="form-label" for="short_description">Short
                                                        Description</label>
                                                    <textarea class="form-control" rows="2" name="short_description" id="short_description">{{ $slider->short_description }}</textarea>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="name" class="form-label">Sort </label>
                                                    <input type="number" class="form-control" id="sort" name="sort"
                                                        value="{{ $slider->sort }}" placeholder="0" required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="status" id="status" class="form-select">
                                                        <option @if ($slider->status) selected @endif
