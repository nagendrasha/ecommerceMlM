						...
						<div class="table-responsive">
							<table class="table mt-3 table-striped table-responsive table-responsive-large inv-tbl"
								...
								<tbody>
									<tr>
										<td>1</td>
										<td><img class="invoice-item-img" src="{{asset('admin/assets/img/products/p1.jpg')}}" alt="product-image" /></td>
									...
									<tr>
										<td>2</td>
										<td><img class="invoice-item-img" src="{{asset('admin/assets/img/products/p2.jpg')}}" alt="product-image"></td>
									...
									<tr>
										<td>3</td>
										<td><img class="invoice-item-img" src="{{asset('admin/assets/img/products/p3.jpg')}}" alt="product-image"></td>
									...
									<tr>
										<td>4</td>
										<td><img class="invoice-item-img" src="{{asset('admin/assets/img/products/p4.jpg')}}" alt="product-image"></td>
