								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="responsive-data-table" class="table">
											...
											<tbody>
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/clothes.png')}}" alt="product image"/></td>
													<td>Winter Wear</td>
													<td>
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/footwear.png')}} " alt="product image" /></td>
													<td>Sport Shoes</td>
													<td>
														<span class="ec-sub-cat-list">
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/cosmetics.png')}} " alt="product image" /></td>
													<td>Makeup kit</td>
													<td>
														<span class="ec-sub-cat-list">
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/glasses.png')}} " alt="product image" /></td>
													<td>Lenses</td>
													<td>
														<span class="ec-sub-cat-list">
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/bag.png')}} " alt="product image" /></td>
													<td>Shopping Bag</td>
													<td>
														<span class="ec-sub-cat-list">
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/jewelry.png')}} " alt="product image" /></td>
													<td>Earing</td>
													<td>
														<span class="ec-sub-cat-list">
												...
												<tr>
													<td><img class="cat-thumb" src="{{asset('admin/assets/img/category/perfume.png')}} " alt="product image" /></td>
													<td>Deodorant</td>
													<td>
														<span class="ec-sub-cat-list">
